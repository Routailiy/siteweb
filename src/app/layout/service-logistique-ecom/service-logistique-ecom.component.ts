...
@Component({
  selector: 'app-service-logistique-ecom',
  templateUrl: './service-logistique-ecom.component.html',
  styleUrls: ['./service-logistique-ecom.component.css']
})
export class ServiceLogistiqueEcomComponent {
  service_details_1=[
 ...
 title_1 ="Solution e-logistique";
 service_img_1="/assets/services_images/e-logistique1.png";
 order_1="order-0";
 service_details_2=[
...
title_2 ="Avantages";
service_img_2="/assets/services_images/e-logistique2.png";
